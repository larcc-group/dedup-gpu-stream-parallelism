...
dataset_size = { # in MB
    'large': 193034240 / (1024*1024),
    'linux': 854784000 / (1024*1024),
    'silesia': 211957760 / (1024*1024),
}
        ...
        for env in environments:
            ...
            for ver in versions:
                if env in data and ver in data[env]:
                    ...
                    throughput = np.divide(dataset_size[dataset], data_seconds)
                    ...
                    ax1.annotate(
                        "%.1f" % value if value < 10 else "%.0f" % value,
                        (pos, value),
                        va='bottom',
                        ha='center',
                        xytext=(0, 3+(stderr*9)),
